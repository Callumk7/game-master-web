				...
				<PopoverContent className="p-0">
					<Card className="w-80 border-0 shadow-lg">
						...
						<CardContent className="space-y-6">
							...
							<div className="space-y-3">
								...
								<div className="flex flex-col gap-2">
									...
									{isDevelopment && onTogglePerformanceMonitoring && (
										<Button
											size="sm"
											variant={performanceMonitoring ? "default" : "secondary"}
							...
							{/* Force Parameters */}
							<div className="space-y-3">
								<h3 className="text-xs font-medium text-muted-foreground">Force Parameters</h3>
								<div className="space-y-4">
									<div className="space-y-2">
										...
										<Slider
											...
											onValueChange={(value) =>
												onConfigChange({
													repulsionStrength: Array.isArray(
														value,
													)
														? value[0]
														: value,
									...
									<div className="space-y-2">
										...
										<Slider
											...
											onValueChange={(value) =>
												onConfigChange({
													attractionStrength: Array.isArray(
														value,
													)
														? value[0]
														: value,
									...
									<div className="space-y-2">
										...
										>
											Center Force:{" "}
											{config.centerForceStrength * 0.00001}
										</label>
										<Slider
											id="center-slider"
											...
											onValueChange={(value) =>
												onConfigChange({
													centerForceStrength: Array.isArray(
														value,
													)
														? value[0]
														: value,
