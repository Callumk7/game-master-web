...
import { type Options, confirmEmailChange, getFactionLinks, createFactionLink, listLocations, createLocation, requestEmailChange, logoutUser, loginUser, deleteLocationLink, updateLocationLink, searchGame, listGameMembers, addGameMember, getEntityImageStats, deleteUserAvatar, uploadUserAvatar, deleteLocation, getLocation, updateLocation, listFactions, createFaction, deleteCharacterLink, updateCharacterLink, listGameEntities, getNoteLinks, createNoteLink, deleteObjective, getObjective, updateObjective, serveEntityImageFile, setEntityImageAsPrimary, getLocationTree, removeCharacterPrimaryFaction, getCharacterPrimaryFaction, setCharacterPrimaryFaction, pinCharacter, getFactionMembers, listQuests, createQuest, listGameImages, deleteNote, getNote, updateNote, getCharacterLinks, createCharacterLink, listCharacters, createCharacter, deleteGame, getGame, updateGame, getEntityPrimaryImage, getGameEntityTree, unpinCharacter, signupUser, getAuthStatus, deleteQuest, getQuest, updateQuest, getLocationLinks, createLocationLink, getUserProfile, updateUserProfile, listGameObjectives, deleteEntityImage, getEntityImage, updateEntityImage, deleteNoteLink, updateNoteLink, resendConfirmation, listObjectives, createObjective, deleteCharacter, getCharacter, updateCharacter, getQuestLinks, createQuestLink, deleteFaction, getFaction, updateFaction, listEntityImages, uploadEntityImage, completeObjective, removeGameMember, uncompleteObjective, deleteFactionLink, updateFactionLink, listNotes, createNote, listPinnedEntities, listGames, createGame, confirmEmail, deleteQuestLink, updateQuestLink, getQuestTree } from '../sdk.gen';
import { type UseMutationOptions, queryOptions, useQuery, infiniteQueryOptions, type InfiniteData, type DefaultError } from '@tanstack/react-query';
import type { ConfirmEmailChangeData, ConfirmEmailChangeError, ConfirmEmailChangeResponse, GetFactionLinksData, CreateFactionLinkData, CreateFactionLinkError, ListLocationsData, CreateLocationData, CreateLocationError, CreateLocationResponse, RequestEmailChangeData, RequestEmailChangeError, RequestEmailChangeResponse, LogoutUserData, LogoutUserError, LoginUserData, LoginUserError, LoginUserResponse, DeleteLocationLinkData, DeleteLocationLinkError, UpdateLocationLinkData, UpdateLocationLinkError, UpdateLocationLinkResponse, SearchGameData, SearchGameError, SearchGameResponse, ListGameMembersData, AddGameMemberData, AddGameMemberError, GetEntityImageStatsData, DeleteUserAvatarData, DeleteUserAvatarError, DeleteUserAvatarResponse, UploadUserAvatarData, UploadUserAvatarError, UploadUserAvatarResponse, DeleteLocationData, DeleteLocationError, GetLocationData, UpdateLocationData, UpdateLocationError, UpdateLocationResponse, ListFactionsData, CreateFactionData, CreateFactionError, CreateFactionResponse, DeleteCharacterLinkData, DeleteCharacterLinkError, UpdateCharacterLinkData, UpdateCharacterLinkError, UpdateCharacterLinkResponse, ListGameEntitiesData, GetNoteLinksData, CreateNoteLinkData, CreateNoteLinkError, CreateNoteLinkResponse, DeleteObjectiveData, DeleteObjectiveError, GetObjectiveData, UpdateObjectiveData, UpdateObjectiveError, UpdateObjectiveResponse, ServeEntityImageFileData, SetEntityImageAsPrimaryData, SetEntityImageAsPrimaryError, SetEntityImageAsPrimaryResponse, GetLocationTreeData, RemoveCharacterPrimaryFactionData, RemoveCharacterPrimaryFactionError, RemoveCharacterPrimaryFactionResponse, GetCharacterPrimaryFactionData, SetCharacterPrimaryFactionData, SetCharacterPrimaryFactionError, SetCharacterPrimaryFactionResponse, PinCharacterData, PinCharacterError, PinCharacterResponse, GetFactionMembersData, ListQuestsData, CreateQuestData, CreateQuestError, CreateQuestResponse, ListGameImagesData, ListGameImagesError, ListGameImagesResponse, DeleteNoteData, DeleteNoteError, GetNoteData, UpdateNoteData, UpdateNoteError, UpdateNoteResponse, GetCharacterLinksData, CreateCharacterLinkData, CreateCharacterLinkError, ListCharactersData, CreateCharacterData, CreateCharacterError, CreateCharacterResponse, DeleteGameData, DeleteGameError, GetGameData, UpdateGameData, UpdateGameError, UpdateGameResponse, GetEntityPrimaryImageData, GetGameEntityTreeData, UnpinCharacterData, UnpinCharacterError, UnpinCharacterResponse, SignupUserData, SignupUserError, SignupUserResponse, GetAuthStatusData, DeleteQuestData, DeleteQuestError, GetQuestData, UpdateQuestData, UpdateQuestError, UpdateQuestResponse, GetLocationLinksData, CreateLocationLinkData, CreateLocationLinkError, GetUserProfileData, UpdateUserProfileData, UpdateUserProfileError, UpdateUserProfileResponse, ListGameObjectivesData, DeleteEntityImageData, DeleteEntityImageError, GetEntityImageData, UpdateEntityImageData, UpdateEntityImageError, UpdateEntityImageResponse, DeleteNoteLinkData, DeleteNoteLinkError, UpdateNoteLinkData, UpdateNoteLinkError, UpdateNoteLinkResponse, ResendConfirmationData, ResendConfirmationResponse, ListObjectivesData, CreateObjectiveData, CreateObjectiveError, CreateObjectiveResponse, DeleteCharacterData, DeleteCharacterError, GetCharacterData, UpdateCharacterData, UpdateCharacterError, UpdateCharacterResponse, GetQuestLinksData, CreateQuestLinkData, CreateQuestLinkError, DeleteFactionData, DeleteFactionError, GetFactionData, UpdateFactionData, UpdateFactionError, UpdateFactionResponse, ListEntityImagesData, UploadEntityImageData, UploadEntityImageError, UploadEntityImageResponse, CompleteObjectiveData, CompleteObjectiveError, CompleteObjectiveResponse, RemoveGameMemberData, RemoveGameMemberError, UncompleteObjectiveData, UncompleteObjectiveError, UncompleteObjectiveResponse, DeleteFactionLinkData, DeleteFactionLinkError, UpdateFactionLinkData, UpdateFactionLinkError, UpdateFactionLinkResponse, ListNotesData, CreateNoteData, CreateNoteError, CreateNoteResponse, ListPinnedEntitiesData, ListGamesData, CreateGameData, CreateGameError, CreateGameResponse, ConfirmEmailData, ConfirmEmailError, ConfirmEmailResponse, DeleteQuestLinkData, DeleteQuestLinkError, UpdateQuestLinkData, UpdateQuestLinkError, UpdateQuestLinkResponse, GetQuestTreeData } from '../types.gen';
 ...
 */
export const confirmEmailChangeMutation = (options?: Partial<Options<ConfirmEmailChangeData>>): UseMutationOptions<ConfirmEmailChangeResponse, ConfirmEmailChangeError, Options<ConfirmEmailChangeData>> => {
    const mutationOptions: UseMutationOptions<ConfirmEmailChangeResponse, ConfirmEmailChangeError, Options<ConfirmEmailChangeData>> = {
 ...
 */
export const requestEmailChangeMutation = (options?: Partial<Options<RequestEmailChangeData>>): UseMutationOptions<RequestEmailChangeResponse, RequestEmailChangeError, Options<RequestEmailChangeData>> => {
    const mutationOptions: UseMutationOptions<RequestEmailChangeResponse, RequestEmailChangeError, Options<RequestEmailChangeData>> = {
        mutationFn: async (fnOptions) => {
...
export const searchGameQueryKey = (options: Options<SearchGameData>) => createQueryKey('searchGame', options);
 ...
 *
 */
export const searchGameOptions = (options: Options<SearchGameData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: searchGameQueryKey(options)
    });
};
...
export const searchGameInfiniteQueryKey = (options: Options<SearchGameData>): QueryKey<Options<SearchGameData>> => createQueryKey('searchGame', options, true);
 ...
 *
 */
export const searchGameInfiniteOptions = (options: Options<SearchGameData>) => {
    return infiniteQueryOptions<SearchGameResponse, SearchGameError, InfiniteData<SearchGameResponse>, QueryKey<Options<SearchGameData>>, number | Pick<QueryKey<Options<SearchGameData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<SearchGameData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: searchGameInfiniteQueryKey(options)
    });
};
 ...
 *
 */
export const useSearchGameQuery = (options: Options<SearchGameData>) => {
    return useQuery(searchGameOptions(options));
};
...
export const getEntityImageStatsQueryKey = (options: Options<GetEntityImageStatsData>) => createQueryKey('getEntityImageStats', options);

/**
 * Get image statistics
 * Get statistics about images for an entity (count, total size, etc.)
 */
export const getEntityImageStatsOptions = (options: Options<GetEntityImageStatsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getEntityImageStats({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getEntityImageStatsQueryKey(options)
    });
};
 ...
 * Get statistics about images for an entity (count, total size, etc.)
 */
export const useGetEntityImageStatsQuery = (options: Options<GetEntityImageStatsData>) => {
    return useQuery(getEntityImageStatsOptions(options));
};
 ...
 */
export const deleteUserAvatarMutation = (options?: Partial<Options<DeleteUserAvatarData>>): UseMutationOptions<DeleteUserAvatarResponse, DeleteUserAvatarError, Options<DeleteUserAvatarData>> => {
    const mutationOptions: UseMutationOptions<DeleteUserAvatarResponse, DeleteUserAvatarError, Options<DeleteUserAvatarData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const uploadUserAvatarMutation = (options?: Partial<Options<UploadUserAvatarData>>): UseMutationOptions<UploadUserAvatarResponse, UploadUserAvatarError, Options<UploadUserAvatarData>> => {
    const mutationOptions: UseMutationOptions<UploadUserAvatarResponse, UploadUserAvatarError, Options<UploadUserAvatarData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * Delete an objective
 */
export const deleteObjectiveMutation = (options?: Partial<Options<DeleteObjectiveData>>): UseMutationOptions<unknown, DeleteObjectiveError, Options<DeleteObjectiveData>> => {
    const mutationOptions: UseMutationOptions<unknown, DeleteObjectiveError, Options<DeleteObjectiveData>> = {
        mutationFn: async (fnOptions) => {
...
export const getObjectiveQueryKey = (options: Options<GetObjectiveData>) => createQueryKey('getObjective', options);

/**
 * Get objective
 * Get a single objective
 */
export const getObjectiveOptions = (options: Options<GetObjectiveData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getObjectiveQueryKey(options)
    });
};
 ...
 * Get a single objective
 */
export const useGetObjectiveQuery = (options: Options<GetObjectiveData>) => {
    return useQuery(getObjectiveOptions(options));
};
 ...
 */
export const updateObjectiveMutation = (options?: Partial<Options<UpdateObjectiveData>>): UseMutationOptions<UpdateObjectiveResponse, UpdateObjectiveError, Options<UpdateObjectiveData>> => {
    const mutationOptions: UseMutationOptions<UpdateObjectiveResponse, UpdateObjectiveError, Options<UpdateObjectiveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateObjective({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const serveEntityImageFileQueryKey = (options: Options<ServeEntityImageFileData>) => createQueryKey('serveEntityImageFile', options);

/**
 * Serve image file
 * Serve or redirect to the actual image file
 */
export const serveEntityImageFileOptions = (options: Options<ServeEntityImageFileData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await serveEntityImageFile({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: serveEntityImageFileQueryKey(options)
    });
};
 ...
 * Serve or redirect to the actual image file
 */
export const useServeEntityImageFileQuery = (options: Options<ServeEntityImageFileData>) => {
    return useQuery(serveEntityImageFileOptions(options));
};
 ...
 */
export const setEntityImageAsPrimaryMutation = (options?: Partial<Options<SetEntityImageAsPrimaryData>>): UseMutationOptions<SetEntityImageAsPrimaryResponse, SetEntityImageAsPrimaryError, Options<SetEntityImageAsPrimaryData>> => {
    const mutationOptions: UseMutationOptions<SetEntityImageAsPrimaryResponse, SetEntityImageAsPrimaryError, Options<SetEntityImageAsPrimaryData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setEntityImageAsPrimary({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listGameImagesQueryKey = (options: Options<ListGameImagesData>) => createQueryKey('listGameImages', options);

/**
 * List all images for a game
 * Retrieve all images across all entities within a specific game
 */
export const listGameImagesOptions = (options: Options<ListGameImagesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listGameImages({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listGameImagesQueryKey(options)
    });
};

export const listGameImagesInfiniteQueryKey = (options: Options<ListGameImagesData>): QueryKey<Options<ListGameImagesData>> => createQueryKey('listGameImages', options, true);

/**
 * List all images for a game
 * Retrieve all images across all entities within a specific game
 */
export const listGameImagesInfiniteOptions = (options: Options<ListGameImagesData>) => {
    return infiniteQueryOptions<ListGameImagesResponse, ListGameImagesError, InfiniteData<ListGameImagesResponse>, QueryKey<Options<ListGameImagesData>>, number | Pick<QueryKey<Options<ListGameImagesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListGameImagesData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listGameImagesInfiniteQueryKey(options)
    });
};
 ...
 * Retrieve all images across all entities within a specific game
 */
export const useListGameImagesQuery = (options: Options<ListGameImagesData>) => {
    return useQuery(listGameImagesOptions(options));
};
...
export const getEntityPrimaryImageQueryKey = (options: Options<GetEntityPrimaryImageData>) => createQueryKey('getEntityPrimaryImage', options);

/**
 * Get primary image
 * Get the primary image for an entity
 */
export const getEntityPrimaryImageOptions = (options: Options<GetEntityPrimaryImageData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getEntityPrimaryImage({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getEntityPrimaryImageQueryKey(options)
    });
};
 ...
 * Get the primary image for an entity
 */
export const useGetEntityPrimaryImageQuery = (options: Options<GetEntityPrimaryImageData>) => {
    return useQuery(getEntityPrimaryImageOptions(options));
};
 ...
 * Retrieve the current user's profile information
 */
export const useGetUserProfileQuery = (options?: Options<GetUserProfileData>) => {
    return useQuery(getUserProfileOptions(options));
};
...
export const listGameObjectivesQueryKey = (options: Options<ListGameObjectivesData>) => createQueryKey('listGameObjectives', options);

/**
 * List all quest objectives for a game
 */
export const listGameObjectivesOptions = (options: Options<ListGameObjectivesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listGameObjectives({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listGameObjectivesQueryKey(options)
    });
};
 ...
 * List all quest objectives for a game
 */
export const useListGameObjectivesQuery = (options: Options<ListGameObjectivesData>) => {
    return useQuery(listGameObjectivesOptions(options));
};
 ...
 */
export const deleteEntityImageMutation = (options?: Partial<Options<DeleteEntityImageData>>): UseMutationOptions<unknown, DeleteEntityImageError, Options<DeleteEntityImageData>> => {
    const mutationOptions: UseMutationOptions<unknown, DeleteEntityImageError, Options<DeleteEntityImageData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteEntityImage({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getEntityImageQueryKey = (options: Options<GetEntityImageData>) => createQueryKey('getEntityImage', options);

/**
 * Get an image by ID
 * Retrieve a specific image by its ID
 */
export const getEntityImageOptions = (options: Options<GetEntityImageData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getEntityImage({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getEntityImageQueryKey(options)
    });
};
 ...
 * Retrieve a specific image by its ID
 */
export const useGetEntityImageQuery = (options: Options<GetEntityImageData>) => {
    return useQuery(getEntityImageOptions(options));
};
 ...
 */
export const updateEntityImageMutation = (options?: Partial<Options<UpdateEntityImageData>>): UseMutationOptions<UpdateEntityImageResponse, UpdateEntityImageError, Options<UpdateEntityImageData>> => {
    const mutationOptions: UseMutationOptions<UpdateEntityImageResponse, UpdateEntityImageError, Options<UpdateEntityImageData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateEntityImage({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const resendConfirmationMutation = (options?: Partial<Options<ResendConfirmationData>>): UseMutationOptions<ResendConfirmationResponse, DefaultError, Options<ResendConfirmationData>> => {
    const mutationOptions: UseMutationOptions<ResendConfirmationResponse, DefaultError, Options<ResendConfirmationData>> = {
        mutationFn: async (fnOptions) => {
...
export const listObjectivesQueryKey = (options: Options<ListObjectivesData>) => createQueryKey('listObjectives', options);

/**
 * List objectives
 * Get all objectives for a quest
 */
export const listObjectivesOptions = (options: Options<ListObjectivesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: listObjectivesQueryKey(options)
    });
};
 ...
 * Get all objectives for a quest
 */
export const useListObjectivesQuery = (options: Options<ListObjectivesData>) => {
    return useQuery(listObjectivesOptions(options));
};
 ...
 */
export const createObjectiveMutation = (options?: Partial<Options<CreateObjectiveData>>): UseMutationOptions<CreateObjectiveResponse, CreateObjectiveError, Options<CreateObjectiveData>> => {
    const mutationOptions: UseMutationOptions<CreateObjectiveResponse, CreateObjectiveError, Options<CreateObjectiveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createObjective({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listEntityImagesQueryKey = (options: Options<ListEntityImagesData>) => createQueryKey('listEntityImages', options);

/**
 * List images for an entity
 * Retrieve all images associated with a specific game entity
 */
export const listEntityImagesOptions = (options: Options<ListEntityImagesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listEntityImages({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listEntityImagesQueryKey(options)
    });
};
 ...
 * Retrieve all images associated with a specific game entity
 */
export const useListEntityImagesQuery = (options: Options<ListEntityImagesData>) => {
    return useQuery(listEntityImagesOptions(options));
};
 ...
 */
export const uploadEntityImageMutation = (options?: Partial<Options<UploadEntityImageData>>): UseMutationOptions<UploadEntityImageResponse, UploadEntityImageError, Options<UploadEntityImageData>> => {
    const mutationOptions: UseMutationOptions<UploadEntityImageResponse, UploadEntityImageError, Options<UploadEntityImageData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await uploadEntityImage({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const completeObjectiveMutation = (options?: Partial<Options<CompleteObjectiveData>>): UseMutationOptions<CompleteObjectiveResponse, CompleteObjectiveError, Options<CompleteObjectiveData>> => {
    const mutationOptions: UseMutationOptions<CompleteObjectiveResponse, CompleteObjectiveError, Options<CompleteObjectiveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeObjective({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const uncompleteObjectiveMutation = (options?: Partial<Options<UncompleteObjectiveData>>): UseMutationOptions<UncompleteObjectiveResponse, UncompleteObjectiveError, Options<UncompleteObjectiveData>> => {
    const mutationOptions: UseMutationOptions<UncompleteObjectiveResponse, UncompleteObjectiveError, Options<UncompleteObjectiveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await uncompleteObjective({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const confirmEmailMutation = (options?: Partial<Options<ConfirmEmailData>>): UseMutationOptions<ConfirmEmailResponse, ConfirmEmailError, Options<ConfirmEmailData>> => {
    const mutationOptions: UseMutationOptions<ConfirmEmailResponse, ConfirmEmailError, Options<ConfirmEmailData>> = {
        mutationFn: async (fnOptions) => {
