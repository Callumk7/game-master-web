...
export const getFactionNotesTreeQueryKey = (options: Options<GetFactionNotesTreeData>) => createQueryKey('getFactionNotesTree', options);

/**
 * Get faction notes tree
 * Get hierarchical tree of notes associated with a faction
 */
export const getFactionNotesTreeOptions = (options: Options<GetFactionNotesTreeData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getFactionNotesTree({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getFactionNotesTreeQueryKey(options)
    });
};
 ...
 * Get hierarchical tree of notes associated with a faction
 */
export const useGetFactionNotesTreeQuery = (options: Options<GetFactionNotesTreeData>) => {
    return useQuery(getFactionNotesTreeOptions(options));
};
