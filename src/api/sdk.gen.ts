...
export const searchGame = <ThrowOnError extends boolean = false>(options: Options<SearchGameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<SearchGameResponses, SearchGameErrors, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
 ...
 */
export const resendConfirmation = <ThrowOnError extends boolean = false>(options: Options<ResendConfirmationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResendConfirmationResponses, unknown, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
 ...
 */
export const confirmEmail = <ThrowOnError extends boolean = false>(options: Options<ConfirmEmailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ConfirmEmailResponses, ConfirmEmailErrors, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
