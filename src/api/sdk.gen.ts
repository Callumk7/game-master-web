 ...
 */
export const getFactionNotesTree = <ThrowOnError extends boolean = false>(options: Options<GetFactionNotesTreeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetFactionNotesTreeResponses, GetFactionNotesTreeErrors, ThrowOnError>({
        security: [
            {
                name: 'Authorization',
                type: 'apiKey'
        ...
        url: '/api/games/{game_id}/factions/{id}/notes/tree',
        ...options
    });
};
