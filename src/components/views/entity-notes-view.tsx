...
export function EntityNotesView({
	...
	return (
		<div className="space-y-4">
			...
			<div className="flex flex-col lg:flex-row gap-4 max-h-[calc(100vh-12.5rem)]">
				{/* Notes List - Left Column */}
				<div className="w-full lg:w-1/4 border bg-sidebar">
					{notes.length === 0 ? (
				...
				<div className="flex-1 flex flex-col min-w-0 border">
					<div className="relative max-w-full overflow-y-scroll">
						{selectedNote ? (
							<>
