...
const SidebarMenuAction = ({
	...
	return (
		<button
			...
			className={cn(
				"absolute right-1 top-1 flex aspect-square w-5 items-center justify-center rounded-md p-1 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-hover/menu-button:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0",
...
const SidebarGroupAction = ({ className, ...props }: React.ComponentProps<"button">) => {
	return (
		<button
			...
			className={cn(
				"absolute right-3 top-3 flex aspect-square w-5 items-center justify-center rounded-md p-1 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				// Increases the hit area of the button on mobile.
				"after:absolute after:-inset-2 after:md:hidden",
				"group-data-[collapsible=icon]:hidden",
				className,
